 ...
 * });
 */
export function useGetRelationsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetRelationsQuery, GetRelationsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<GetRelationsQuery, GetRelationsQueryVariables>(GetRelationsDocument, options);
      }
export function useGetRelationsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetRelationsQuery, GetRelationsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<GetRelationsQuery, GetRelationsQueryVariables>(GetRelationsDocument, options);
        }
